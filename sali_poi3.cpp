...
// LD_LIBRARY_PATH=/opt/intel/oneapi/tbb/2021.12/lib:$LD_LIBRARY_PATH ./sali_poi3 test 1000000 1 100000 1
...
//   }
   ...
   //Check if the dataset has any duplicates
    ...
    std::string performance_output = output_folder+"results/sali3/insert/sali_insert_original_performance.csv";
    std::string structure_output = output_folder+"results/sali3/insert/sali_insert_original_structure.csv";

    if(poison){
        performance_output = output_folder+"results/sali3/insert/sali_insert_poisoned_performance.csv";
        structure_output = output_folder+"results/sali3/insert/sali_insert_poisoned_structure.csv";
    }
    ...
    std::string output_model_csv = output_folder+"results/sali3/sali_insert_model_output_good.csv";
