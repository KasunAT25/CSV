// RUN using
// commented all the saves 2 in lipp benchmark ind and 1 in this savestructure and benchmark
// g++ lipp_poi3.cpp -std=c++17 -o lipp_poi3 -march=native -mpopcnt


// ./lipp_poi ../../../ext/Data/fb_200M_uint64 1000000
// ./lipp_poi2 test 1000000 0 100000 1
// nohup ./lipp_poi test 1000000 1 100000 0 &

// ps aux | head -n 1 && ps aux | grep ./benchmark_lipp
// ps aux | head -n 1 && ps aux | grep ./lipp_poi

// g++ -fopenmp -I /opt/intel/oneapi/tbb/2021.12/include lipp_poi.cpp -std=c++17 -o lipp_poi -L /opt/intel/oneapi/tbb/2021.12/lib -ltbb -march=native -mpopcnt
// LD_LIBRARY_PATH=/opt/intel/oneapi/tbb/2021.12/lib:$LD_LIBRARY_PATH ./lipp_poi ../../../ext/Data/fb_200M_uint64 50000

//  ./lipp_poi2 fb 200000000 0 10000000 1
...
#include "src/helpers/pgm_benchmark_real_new.h"
...
//   }
   ...
   //Check if the dataset has any duplicates
    ...
    std::string performance_output = output_folder+"results/lipp2/insert/lipp_insert2_original_performance.csv";
    std::string structure_output = output_folder+"results/lipp2/insert/lipp_insert2_original_structure.csv";

    if(poison){
        performance_output = output_folder+"results/lipp2/insert/lipp_insert2_poisoned_performance.csv";
        structure_output = output_folder+"results/lipp2/insert/lipp_insert2_poisoned_structure.csv";
    }
    ...
    std::string output_model_csv = output_folder+"results/lipp2/insert/lipp_insert2_model_output_good.csv";
    ...
    LIPP<KEY_TYPE, PAYLOAD_TYPE> index_original;
    ...
    // numberOfIndexes = values_size*(1-0.5);
   ...
   // std::cout << " Number " << index_original.root->size <<std::endl;
    ...
    //     // benchmark_lipp_real(index,lookup_keys_level, lookup_keys_level, "LIPP", dataset_name+"_lookup_level_"+std::to_string(i), 
    ...
    //     }
        ...
        size_t index_size_after2 =  index.index_size(true,false);
         ...
         std::string model_results = "LIPP;" + dataset_name + "_insert_"+std::to_string(j)+ ";" + std::to_string(poison) + ";"+ std::to_string(insert) + ";" +
          std::to_string(orignal_P)  + ";"  + std::to_string(insert_threshold) + ";" +std::to_string(legitimate_data.size()) +";"
    ...
    //     //std::cout << loss_value << " MSE " << mse << std::endl;
