...
// LD_LIBRARY_PATH=/opt/intel/oneapi/tbb/2021.12/lib:$LD_LIBRARY_PATH ./sali_csv test 1000000 1 0.1 0 
...
int main(int argc, char *argv[]){
    //std::cout << "Test to clear memory cache." << std::endl;
    clearMemoryCache();
    ...
    std::string performance_output = output_folder+"results/sali/sali_original_performance.csv";
    std::string structure_output = output_folder+"results/sali/sali_original_structure.csv";

    if(poison){
        performance_output = output_folder+"results/sali/sali_smooth_performance.csv";
        structure_output = output_folder+"results/sali/sali_smooth_structure.csv";
    }
    ...
    std::string output_model_csv = output_folder+"results/sali/sali_model_output_good.csv";
