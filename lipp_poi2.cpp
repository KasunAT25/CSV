...
//   }
   ...
   //Check if the dataset has any duplicates
    ...
    std::string performance_output = output_folder+"results/lipp2/insert/lipp3_insert_original_performance.csv";
    std::string structure_output = output_folder+"results/lipp2/insert/lipp3_insert_original_structure.csv";

    if(poison){
        performance_output = output_folder+"results/lipp2/insert/lipp3_insert_poisoned_performance.csv";
        structure_output = output_folder+"results/lipp2/insert/lipp3_insert_poisoned_structure.csv";
    }
    ...
    std::string output_model_csv = output_folder+"results/lipp2/insert/lipp3_insert_model_output_good.csv";
