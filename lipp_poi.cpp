// RUN using
// I CHANGED THE POISONING_SIMPLE TO EXHAUSTIVE
// CURRENT_LEVEL = 2 TO = MAX_LEVEL
// WHILE LOOP CURRENT_LEVEL == 2 TO MAX LEVEL
...
// ./lipp_poi test 1000000 1 100000 0
...
//  ./lipp_poi lognormal 200000000 1 10000000 0
...
int main(int argc, char *argv[]){
    ...
    std::string performance_output = output_folder+"results/lipp_100/lipp2_original_performance.csv";
    std::string structure_output = output_folder+"results/lipp_100/lipp2_original_structure.csv";

    if(poison){
        performance_output = output_folder+"results/lipp_100/lipp2_poisoned_performance.csv";
        structure_output = output_folder+"results/lipp_100/lipp2_poisoned_structure.csv";
    }
    ...
    std::string output_model_csv = output_folder+"results/lipp_100/lipp2_model_output_good.csv";
